...
defmodule GolbachConjecture do
  
  def compute(n) do
    [head|tail] = primeList(2,n) #in Golbach Conjecture the first prime number (1) is not used, this is why primeList start from 2
    do_compute(n,[head],[head|tail],[head|tail])
  end
